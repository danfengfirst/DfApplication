...
package com.df.audiorecord.utils.audio2;
...
public class SamplePlayer2 {
    ...
    public SamplePlayer2(ShortBuffer samples, int sampleRate, int channels, int numSamples) {
        mSamples = samples;
    ...
    public SamplePlayer2(SoundFile2 sf) {
