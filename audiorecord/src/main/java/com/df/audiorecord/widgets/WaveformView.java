...
import com.df.audiorecord.utils.audio.SoundFile;
...
public class WaveformView extends View {
    ...
    public WaveformView(Context context, AttributeSet attrs) {
        ...
        setFocusable(false);
        paintLine = new Paint();
        paintLine.setStrokeWidth(getResources().getDimension(R.dimen.x2));
...
//        canvas.drawLine(0, height * 0.5f + line_offset / 2, measuredWidth, height * 0.5f + line_offset / 2, centerLine);//中心线
    ...
    private void computeIntsForThisZoomLevel() {
        ...
        for (int i = 0; i < mLenByZoomLevel[mZoomLevel]; i++) {
            ...
            Log.e("采样数值",+mValuesByZoomLevel[mZoomLevel][i]+"高度"+ mHeightsAtThisZoomLevel[i]);
        }
    }
